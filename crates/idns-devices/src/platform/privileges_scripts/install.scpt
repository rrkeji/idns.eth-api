on run {daemon_file, agent_file, user}
  ...
  set sh3 to "cp -rf /Users/" & user & "/Library/Preferences/com.carriez.IdnsEth/IdnsEth.toml /var/root/Library/Preferences/com.carriez.IdnsEth/;"

  set sh4 to "cp -rf /Users/" & user & "/Library/Preferences/com.carriez.IdnsEth/RustDesk2.toml /var/root/Library/Preferences/com.carriez.IdnsEth/;"

  set sh5 to "launchctl load -w /Library/LaunchDaemons/com.carriez.RustDesk_service.plist;"

  set sh to sh1 & sh2 & sh3 & sh4 & sh5

  do shell script sh with prompt "IdnsEth want to install daemon and agent" with administrator privileges
end run
