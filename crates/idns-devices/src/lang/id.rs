...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan IdnsEth..."),
        ...
        ("install_tip", "Karena UAC, IdnsEth tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal IdnsEth ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Kli untuk download"),
        ("Click to update", "Klik untuk update"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" IdnsEth."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" IdnsEth."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan IdnsEth untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input IdnsEth]."),
        ...
        ("Language", "Bahasa"),
        ("Keep IdnsEth background service", "Pertahankan IdnsEth berjalan pada background service"),
