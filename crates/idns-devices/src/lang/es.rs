...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red IdnsEth en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que IdnsEth no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar IdnsEth a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a IdnsEth de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a IdnsEth de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del mouse o toque, debe permitir que IdnsEth use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [IdnsEth Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep IdnsEth background service", "Dejar IdnsEth como Servicio en 2do plano"),
