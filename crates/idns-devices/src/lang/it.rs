...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete IdnsEth in corso..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente, IdnsEth potrebbe non funzionare correttamente come desktop remoto. Per evitare questo problema, fai click sul tasto qui sotto per installare IdnsEth a livello di sistema."),
        ("Click to upgrade", "Fai click per aggiornare"),
        ("Click to download", "Cliquez per scaricare"),
        ("Click to update", "Fare clic per aggiornare"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il tuo desktop dall'esterno, devi fornire a IdnsEth il permesso \"Accessibilità\"."),
        ("config_screen", "Per controllare il tuo desktop dall'esterno, devi fornire a IdnsEth il permesso \"Registrazione schermo\"."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare il tuo dispositivo Android tramite mouse o tocco, devi consentire a IdnsEth di utilizzare il servizio \"Accessibilità\"."),
        ("android_input_permission_tip2", "Vai alla pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [IdnsEth Input]."),
