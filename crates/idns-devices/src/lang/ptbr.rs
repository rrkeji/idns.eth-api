...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do IdnsEth..."),
        ...
        ("install_tip", "Devido ao UAC, o IdnsEth não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o IdnsEth no sistema."),
        ...
        ("config_acc", "Para controlar seu Desktop remotamente, você precisa conceder ao IdnsEth permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu Desktop remotamente, você precisa conceder ao IdnsEth permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o IdnsEth use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [IdnsEth Input]."),
