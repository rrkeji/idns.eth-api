...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети IdnsEth..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC IdnsEth может работать некорректно на удаленном узле. Чтобы избежать UAC, нажмите кнопку ниже, чтобы установить IdnsEth в системе"),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удаленно управлять своим рабочим столом, вы должны предоставить IdnsEth права \"доступа\""),
        ("config_screen", "Для удаленного доступа к рабочему столу вы должны предоставить IdnsEth права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удаленное устройство могло управлять вашим Android-устройством с помощью мыши или касания, вам необходимо разрешить IdnsEth использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на следующую страницу системных настроек, найдите и войдите в [Установленные службы], включите службу [IdnsEth Input]."),
        ...
        ("Language", "Язык"),
        ("Keep IdnsEth background service", "Сохранить фоновый службу IdnsEth"),
