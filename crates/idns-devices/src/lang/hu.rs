...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Kapcsolódás a IdnsEth hálózatához..."),
        ...
        ("not_ready_status", "A IdnsEth nem áll készen. Kérlek nézd meg a hálózati beállításaidat."),
        ...
        ("install_tip", "Az UAC (Felhasználói Fiók Felügyelet) miatt, a IdnsEth nem fog rendesen funkcionálni mint távoli oldal néhány esetben. Hogy ezt kikerüld, vagy kikapcsold, kérlek nyomj rá a gombra ezalatt az üzenet alatt, hogy feltelepítsd a RustDesket a rendszerre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "Ahhoz hogy a RustDesket távolról irányítani tudd, \"Elérhetőségi\" jogokat kell adnod a IdnsEth-nek."),
        ("config_screen", "Ahhoz hogy a RustDesket távolról irányítani tudd, \"Képernyőfelvételi\" jogokat kell adnod a IdnsEth-nek."),
        ...
        ("install_daemon_tip", "Ahhoz hogy a IdnsEth bootkor elinduljon, telepítened kell a rendszer szolgáltatást."),
        ("Remote ID", "Távoli ID"),
        ("Paste", "Beillesztés"),
        ...
        ("android_input_permission_tip1", "Ahhoz hogy egy távoli eszköz kontolálhassa az Android eszközödet egérrel vagy érintéssel, jogot kell adnod a IdnsEth-nek, hogy használja az \"Elérhetőségi\" szolgáltatást."),
        ("android_input_permission_tip2", "Kérlek navigálj a rendszer beállításaihoz, keresd meg vagy írd be hogy [Feltelepített Szolgáltatások], és kapcsold be a [IdnsEth Input] szolgáltatást."),
