...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "IdnsEth 네트워크로 연결중입니다..."),
        ...
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [IdnsEth Input] 서비스를 켜십시오."),
        ...
        ("Language", "언어"),
        ("Keep IdnsEth background service", "IdnsEth 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 IdnsEth 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
