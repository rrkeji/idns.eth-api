...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem IdnsEth-Netzwerk..."),
        ...
        ("install_tip", "Aufgrund der UAC kann IdnsEth in manchen Fällen nicht ordnungsgemäß auf der Gegenseite funktionieren. Um UAC zu vermeiden, klicken Sie bitte auf die Schaltfläche unten, um IdnsEth auf dem System zu installieren"),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie IdnsEth Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie IdnsEth \"Bildschirm-Aufnahme\"-Berechtigung erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein Remote-Gerät Ihr Android-Gerät steuern kann, müssen Sie IdnsEth erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen und geben Sie [Installierte Dienste] ein, schalten Sie den Dienst [IdnsEth Input] ein."),
        ...
        ("Language", "Sprache"),
        ("Keep IdnsEth background service", "IdnsEth im Hintergrund ausführen"),
